...
public class MTRandom extends Random {
	 ...
	 * in the class being initialized with a seed value obtained by calling
	 ...
	 * Behavior to the original C code version of this algorithm including
	 ...
	 * where identical behavior is required.
	 * <p>
	...
	/**
	 * This version of the constructor simply initializes the class with
	 ...
	 * 
	 * @param seed The seed value with which to initialize this class.
	 */
	...
	/**
	 * This version of the constructor initializes the class with the
	 * given byte array.  All the data will be used to initialize this
	 * instance.
	 * 
	...
	/**
	 * This version of the constructor initializes the class with the
	 * given integer array.  All the data will be used to initialize
	 * this instance.
	 * 
	...
	private final void setSeed(int seed) {
		...
		// Annoying runtime check for initialization of internal data
		// caused by java.util.Random invoking setSeed() during init.
		// This is unavoidable because no fields in our instance will
		// have been initialized at this point, not even if the code
	 ...
	 * <p>
	 * If this instance was initialized in 'compatibility' mode then
	 * this method will only use the lower 32 bits of any seed value
	 * passed in and will match the behavior of the original C code
	 * exactly with respect to state initialization.
	 * 
	 * @param seed The 64 bit value used to initialize the random
	 ...
	 * (inherited from Random) we are able to replicate behavior exactly.
	 * <p>
	...
	protected final synchronized int next(int bits) {
		...
		if (mti >= N) {             // generate N words at one time
			...
			// to determine if initialization has occurred; if not
			// it initializes this instance with DEFAULT_SEED (5489).
			// This is no longer necessary as initialization of the
			// Java instance must result in initialization occurring
